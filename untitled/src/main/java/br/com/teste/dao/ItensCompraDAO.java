...
public class ItensCompraDAO {
    public int cadastrar(ItensCompra itensCompra){
        String sql = "INSERT INTO tb_itens_compra (id_produto, id_compra, quantidade, valor_unitario) VALUES (?, ?, ?, ?) RETURNING id";
    ...
    public Optional<ItensCompra>buscarPorCompraEProduto(int idCompra) {
        ItensCompra itensCompra = null;
